...
const FoundAnnouncement = () =>{
  ...
  async function handleFormSubmit(event: FormEvent){
    ...
    const reward = 0; 
    const type = 1;
    const { name, email, phone, category, description, photo, city } = formData;
  ...
  return (
    <div className='container'> 
      ...
      <div className='row mt-5'>
        <div className="col-12 text-center text-find">
          ACHEI! :)
        </div>
      </div>
      ...
      <div className='row'>
        <div className="col-12 text-center">
          Opa!! Nos informe o que encontrou para tentarmos localizar o dono!
        </div>
      </div>
        ...
        <div className='row'>
          <div className="col-12">
            ...
            <div className="mb-3">
              ...
              <textarea className="form-control" id="description" name='description' onChange={handleTextareaChange}/>              
            </div>
